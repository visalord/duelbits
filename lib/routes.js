      ...
      if (mDuel[0] !== undefined){
        if (duel.troops === mDuel[0].troops){
          ...
          var result = new Result({
            ...
            matched: true,
            outcome: 'Its a tie!',
            yourTroops: duel.troops / 100000000,
            oppTroops: mDuel[0].troops + duel.troops / 100000000
          });
          ...
          var mResult = new Result({
            ...
            matched: true,
            outcome: 'Its a tie!',
            oppTroops: duel.troops / 100000000,
            yourTroops: mDuel[0].troops / 100000000
          });
          ...
          var result2 = new Result({
            ...
            outcome: 'You Won!',
            yourTroops: duel.troops / 100000000,
            oppTroops: mDuel[0].troops / 100000000
          });
